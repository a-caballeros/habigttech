...
const BinancePayment = () => {
  ...
  const sendReceipt = () => {
    const subject = encodeURIComponent('Comprobante de pago Binance Pay - Suscripción');
    const body = encodeURIComponent(
      `Estimados,\n\nAdjunto el comprobante de pago realizado a través de Binance Pay para mi suscripción:\n\nPlan: ${selectedPlan?.name || 'N/A'}\nModalidad: ${billingCycle || 'N/A'}\nID Binance: ${binanceId}\n\nPor favor, confirmen la activación de mi suscripción.\n\nGracias.`
    );
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-2xl text-primary">Pago con Binance Pay</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-secondary/50 p-4 rounded-lg">
                  <p className="text-sm text-muted-foreground mb-2"><strong>1.</strong> Realiza el pago a través de Binance Pay al siguiente ID:</p>
                  <div className="flex items-center gap-2 bg-background p-3 rounded border">
                    <span className="font-mono font-medium text-lg">{binanceId}</span>
                    <Button 
                      variant="ghost" 
                      size="sm" 
                      onClick={() => copyToClipboard(binanceId)}
                ...
                <div className="bg-secondary/50 p-4 rounded-lg">
                  <p className="text-sm text-muted-foreground"><strong>3.</strong> Incluye en el asunto del correo: "Comprobante de pago Binance Pay - Suscripción"</p>
                </div>
